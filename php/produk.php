...
//if(isset($_POST["tambahkeranjang"])){
  ...
  //$query = "INSERT INTO keranjang VALUES ('', '$gambarproduk' , '$namaproduk' , '$hargaproduk')";
  //mysqli_query ($koneksi,$query);

//}


//while ($prod = mysqli_fetch_assoc($resultproduk)){

//var_dump($prod["namaproduk"]);
//}
  ...
  <div class="modal-wrapper">
    <div id="modal<?=$pro ["idproduk"]; ?>" class= "basemodal m-auto">
        ...
        <form method="post" action="keranjang.php?id=<?= $pro["idproduk"]; ?>">
            ...
            <p class="h4">Rp.<?= number_format( $pro ["hargaproduk"]);?></p>             
            </div>
            ...
            <input type="hidden" name="gambarproduk" value="<?= $pro["gambarproduk"]; ?>">
            ...
            <div class="tambahkeranjang  py-3 text-center">
              <button class="btn btn-success" type="submit" name="addtocart">tambah keranjang</button>
            </div>
        </form>
    </div>
  </div>
